...
public class UserService {
    ...
    public void sendCode(String phone) {
        ...
        msg.put("phone", phone);
        msg.put("code", code);
        amqpTemplate.convertAndSend("ly.sms.exchange","ly.sms.verify.code",msg);
    ...
    public void register(User user, String code) {
        ...
        if (!StringUtils.equals(code, cacheCode)) {
            throw new LyException(HttpStatus.BAD_REQUEST, "手机验证码不正确");
        }
        ...
        //对密码加密
        user.setPassword(CodecUtils.md5Hex(code, salt));
